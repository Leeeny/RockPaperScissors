...
public class Server {
    public static void main(String[] args) throws IOException, ParseException {
        ...
        try {
            ...
            writer.close();
            scanner.close();
        } catch (KeyInSavedGameFileNotFoundException e) {
            System.out.println("Whoops! Something gone wrong with game.json!");
            e.printStackTrace();
        } catch (KeyInStringOfPlayerNotFound e) {
            System.out.println("Whoops! Something gone wrong with getting player from client");
            e.printStackTrace();
        }
    }
}
